...
{
    public class AlTenantOrderGetDetailGetOutput
    {
        public AlTenantOrderGetDetailBascInfo BascInfo { get; set; }

        public List<AlTenantOrderGetDetailCoupons> OrderGetDetailCoupons { get; set; }

        public List<AlTenantOrderGetDetailProductInfo> OrderGetDetailProducts { get; set; }

        public List<AlTenantOrderGetDetailIncomeLog> OrderGetDetailIncomeLogs { get; set; }
    }

    public class AlTenantOrderGetDetailBascInfo
    {
    ...
    public class AlTenantOrderGetDetailCoupons
    {
        public long CId { get; set; }
    ...
    public class AlTenantOrderGetDetailProductInfo
    {
        public long CId { get; set; }
    ...
    public class AlTenantOrderGetDetailIncomeLog
    {
        public long CId { get; set; }
