...
{
    public class AlTenantOrderGetDetailAccountRechargeGetOutput
    {
        public AlTenantOrderGetDetailAccountRechargeOutputBasc BascInfo { get; set; }

        public AlTenantOrderGetDetailAccountRechargeOutputRecharge RechargeLog { get; set; }

        public List<AlTenantOrderGetDetailAccountRechargeOutputIncomeLog> IncomeLogs { get; set; }
    }

    public class AlTenantOrderGetDetailAccountRechargeOutputBasc
    {
    ...
    public class AlTenantOrderGetDetailAccountRechargeOutputRecharge
    {
    ...
    public class AlTenantOrderGetDetailAccountRechargeOutputIncomeLog
    {
        public long CId { get; set; }
