...
{
    public class ActiveGrowthRecordClassGetPagingRequest : RequestPagingBase, IDataLimit
    {
        ...
        public override string ToString()
        {
            ...
            condition.Append($" AND Type = {EmActiveGrowthRecordType.Class}");
            ...
            if (ClassId != null)
            {
                condition.Append($" AND RelatedIds LIKE '%,{ClassId.Value},%'");
            }
            if (StartOt != null)
            {
