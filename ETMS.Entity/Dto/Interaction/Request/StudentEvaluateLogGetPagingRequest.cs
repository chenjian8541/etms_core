...
{
    public class StudentEvaluateLogGetPagingRequest : RequestPagingBase, IDataLimit
    {
        ...
        {
            return $" AND TeacherId = {LoginUserId}";
        }
        ...
        public override string ToString()
        {
            ...
            if (StarValue != null)
            {
                condition.Append($" AND StarValue = {StarValue.Value}");
            }
