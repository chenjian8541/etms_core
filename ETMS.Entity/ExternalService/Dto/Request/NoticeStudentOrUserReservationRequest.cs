...
{
    public class NoticeStudentOrUserReservationRequest : NoticeRequestBase
    {
        public NoticeStudentOrUserReservationRequest(NoticeRequestBase requestBase)
        ...
        public List<NoticeStudentReservationStudent> StudentOrUsers { get; set; }
    }
