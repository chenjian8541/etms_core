...
namespace ETMS.DataAccess.SysOp
{
    public class SysDataClearDAL : DataAccessBase, ISysDataClearDAL
    {
        ...
        public async Task<bool> ClearStudentCourse()
        {
            ...
            sql.Append($"UPDATE EtStudentCourseExTimeDeLog SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            await _dbWrapper.Execute(sql.ToString());
        ...
        public async Task<bool> ClearOrder()
        {
            ...
            sql.Append($"UPDATE EtMallOrder SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtMallCart SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtMallPrepay SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            await _dbWrapper.Execute(sql.ToString());
            return true;
        }
        ...
        public async Task<bool> ClearStatisticsStudent()
        {
            ...
            sql.Append($"UPDATE EtStatisticsStudentCountMonth SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtStatisticsSalesProductMonth SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            await _dbWrapper.Execute(sql.ToString());
            return true;
        }
        ...
        public async Task<bool> ClearStatisticsClass()
        {
            ...
            sql.Append($"UPDATE EtStatisticsEducationMonth SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtStatisticsEducationTeacherMonth SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtStatisticsEducationClassMonth SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtStatisticsEducationCourseMonth SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtStatisticsEducationStudentMonth SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            await _dbWrapper.Execute(sql.ToString());
            return true;
        }
        ...
        public async Task<bool> ClearStudentCheckLog()
        {
            ...
            sql.Append($"UPDATE EtStudentCheckOnStatistics SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
        ...
        public async Task<bool> ClearTeacherSalary()
        {
            ...
            sql.Append($"UPDATE EtTeacherSalaryContractPerformanceSet SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtTeacherSalaryContractPerformanceSetDetail SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtTeacherSalaryPayroll SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
            sql.Append($"UPDATE EtTeacherSalaryPayrollUser SET IsDeleted = {EmIsDeleted.Deleted} WHERE TenantId = {_tenantId};");
