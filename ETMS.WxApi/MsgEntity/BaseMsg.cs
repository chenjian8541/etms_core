...
namespace WxApi.MsgEntity
{
    ...
    public abstract class BaseMsg
    {
        ...
        public virtual string ResText(EnterParam param, string content)
        {
        ...
        /// 回复消息(图片)
        /// </summary>
        public string ResPicture(EnterParam param, string media_id)
        {
            var resxml = new StringBuilder();
            resxml.AppendFormat("<xml><ToUserName><![CDATA[{0}]]></ToUserName>", FromUserName);
            resxml.AppendFormat("<FromUserName><![CDATA[{0}]]></FromUserName>", ToUserName);
        ...
        /// 回复消息(语音)
        /// </summary>
        public string ResVoice(EnterParam param, string media_id)
        {
            var resxml = new StringBuilder();
            resxml.AppendFormat("<xml><ToUserName><![CDATA[{0}]]></ToUserName>", FromUserName);
            resxml.AppendFormat("<FromUserName><![CDATA[{0}]]></FromUserName>", ToUserName);
        ...
        /// 回复消息(视频)
        /// </summary>
        public string ResVideo(EnterParam param, ResVideo video)
        {
            var resxml = new StringBuilder();
            resxml.AppendFormat("<xml><ToUserName><![CDATA[{0}]]></ToUserName>", FromUserName);
            resxml.AppendFormat("<FromUserName><![CDATA[{0}]]></FromUserName>", ToUserName);
        ...
        /// 回复消息(音乐)
        /// </summary>
        public string ResMusic(EnterParam param, ResMusic music)
        {
            var resxml = new StringBuilder();
            resxml.AppendFormat("<xml><ToUserName><![CDATA[{0}]]></ToUserName>", FromUserName);
            resxml.AppendFormat("<FromUserName><![CDATA[{0}]]></FromUserName>", ToUserName);
        ...
        /// 回复图文
        /// </summary>
        public string ResArticles(EnterParam param, List<ResArticle> artList)
        {
            var resxml = new StringBuilder();
            resxml.AppendFormat("<xml><ToUserName><![CDATA[{0}]]></ToUserName>", FromUserName);
            resxml.AppendFormat("<FromUserName><![CDATA[{0}]]></FromUserName>", ToUserName);
        ...
        public string TransDkf(EnterParam param, string account = "")
        {
            var resxml = new StringBuilder();
            resxml.AppendFormat("<xml><ToUserName><![CDATA[{0}]]></ToUserName>", FromUserName);
            resxml.AppendFormat("<FromUserName><![CDATA[{0}]]></FromUserName>", ToUserName);
