    ...
    public class StudentController : ControllerBase
    {
        ...
        public async Task<ResponseBase> StudentDuplicateCheck(StudentDuplicateCheckRequest request)
        {
            try
            {
                ...
                return await _studentBLL.StudentDuplicateCheck(request);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResponseBase> StudentDelList(StudentDelListRequest request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentDelList(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentExtendFieldInfoGet(StudentExtendFieldInfoGetRequest request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentExtendFieldInfoGet(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentTrackLogGet(StudentTrackLogGetRequest request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentTrackLogGet(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentTrackLogEdit(StudentTrackLogEditRequest request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentTrackLogEdit(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentTodayWorkPlanGet(RequestBase request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentTodayWorkPlanGet(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseDetailGet2(StudentCourseDetailGetRequest request)
        {
            ...
            {
                _studentCourseBLL.InitTenantId(request.LoginTenantId);
                return await _studentCourseBLL.StudentCourseDetailGet2(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseAboutFastDeClassTimesGet(StudentCourseAboutFastDeClassTimesGetRequest request)
        {
            ...
            {
                _studentCourseBLL.InitTenantId(request.LoginTenantId);
                return await _studentCourseBLL.StudentCourseAboutFastDeClassTimesGet(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentLeaveApplyLogGet(StudentLeaveApplyLogGetRequest request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentLeaveApplyLogGet(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentLeaveHelpApply(StudentLeaveHelpApplyRequest request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentLeaveHelpApply(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseStopBatch(StudentCourseStopBatchRequest request)
        {
            ...
            {
                _studentCourseBLL.InitTenantId(request.LoginTenantId);
                return await _studentCourseBLL.StudentCourseStopBatch(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseRestoreTimeBatch(StudentCourseRestoreTimeBatchRequest request)
        {
            ...
            {
                _studentCourseBLL.InitTenantId(request.LoginTenantId);
                return await _studentCourseBLL.StudentCourseRestoreTimeBatch(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentClearance(StudentCourseClearRequest request)
        {
            ...
            {
                _studentCourseBLL.InitTenantId(request.LoginTenantId);
                return await _studentCourseBLL.StudentClearance(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseSetCheckDefault(StudentCourseSetCheckDefaultRequest request)
        {
            ...
            {
                _studentCourseBLL.InitTenantId(request.LoginTenantId);
                return await _studentCourseBLL.StudentCourseSetCheckDefault(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseSetIsLimitReserve(StudentCourseSetIsLimitReserveRequest request)
        {
            ...
            {
                _studentCourseBLL.InitTenantId(request.LoginTenantId);
                return await _studentCourseBLL.StudentCourseSetIsLimitReserve(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentChangePwd(StudentChangePwdRequest request)
        {
            ...
            {
                _studentBLL.InitTenantId(request.LoginTenantId);
                return await _studentBLL.StudentChangePwd(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseAndClassGet(StudentCourseAndClassGetRequest request)
        {
            try
            {
                ...
                return await _student2BLL.StudentCourseAndClassGet(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCourseRelationClass(StudentCourseRelationClassRequest request)
        {
            ...
            {
                _student2BLL.InitTenantId(request.LoginTenantId);
                return await _student2BLL.StudentCourseRelationClass(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCheckChoiceStudentCourse(StudentCheckChoiceStudentCourseRequest request)
        {
            ...
            {
                _student2BLL.InitTenantId(request.LoginTenantId);
                return await _student2BLL.StudentCheckChoiceStudentCourse(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentFaceClear(RequestBase request)
        {
            ...
            {
                _student2BLL.InitTenantId(request.LoginTenantId);
                return await _student2BLL.StudentFaceClear(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentBindingFaceCheck(StudentBindingFaceCheckRequest request)
        {
            ...
            {
                _student2BLL.InitTenantId(request.LoginTenantId);
                return await _student2BLL.StudentBindingFaceCheck(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCheckOnStatisticsGetPaging(StudentCheckOnStatisticsGetPagingRequest request)
        {
            ...
            {
                _student2BLL.InitTenantId(request.LoginTenantId);
                return await _student2BLL.StudentCheckOnStatisticsGetPaging(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCheckByHk(StudentCheckByHkRequest request)
        {
            ...
            {
                _student2BLL.InitTenantId(request.LoginTenantId);
                return await _student2BLL.StudentCheckByHk(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
