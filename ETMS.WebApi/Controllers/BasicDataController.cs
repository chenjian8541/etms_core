...
namespace ETMS.WebApi.Controllers
{
    ...
    public class BasicDataController : ControllerBase
    {
        ...
        public async Task<ResponseBase> TenantGetView(TenantGetRequest request)
        {
            ...
            {
                this._tenantBLL.InitTenantId(request.LoginTenantId);
                return await _tenantBLL.TenantGetView(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentCheckInConfigSave(StudentCheckInConfigSaveRequest request)
        {
            ...
            {
                this._appConfigBLL.InitTenantId(request.LoginTenantId);
                return await _appConfigBLL.StudentCheckInConfigSave(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentRecommendConfigSave(StudentRecommendConfigSaveRequest request)
        {
            ...
            {
                this._appConfigBLL.InitTenantId(request.LoginTenantId);
                return await _appConfigBLL.StudentRecommendConfigSave(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentRecommendConfigSave2(StudentRecommendConfigSave2Request request)
        {
            ...
            {
                this._appConfigBLL.InitTenantId(request.LoginTenantId);
                return await _appConfigBLL.StudentRecommendConfigSave2(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> TenantOtherConfigSave(TenantOtherConfigSaveRequest request)
        {
            ...
            {
                this._appConfigBLL.InitTenantId(request.LoginTenantId);
                return await _appConfigBLL.TenantOtherConfigSave(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> TenantConfigGetSimple(RequestBase request)
        {
            ...
            {
                this._appConfigBLL.InitTenantId(request.LoginTenantId);
                return await _appConfigBLL.TenantConfigGetSimple(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
        ...
        public async Task<ResponseBase> StudentLeaveConfigSave(StudentLeaveConfigSaveRequest request)
        {
            ...
            {
                this._appConfigBLL.InitTenantId(request.LoginTenantId);
                return await _appConfigBLL.StudentLeaveConfigSave(request);
            }
            catch (Exception ex)
            {
                Log.Error(request, ex, this.GetType());
